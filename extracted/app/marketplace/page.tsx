...
import { MarketplaceChart } from "@/components/charts/marketplace-chart"
import { 
  marketplaceKPIs, 
...
export default function MarketplacePage() {
  ...
  const [selectedTransaction, setSelectedTransaction] = useState<typeof marketplaceTransactions[0] | null>(null)
  ...
  const filteredTransactions = marketplaceTransactions.filter(tx => {
        ...
        <main className="flex-1 p-4 lg:p-6 pb-24 lg:pb-6 overflow-auto">
          ...
          <div className="mt-6 bg-card rounded-xl p-4 lg:p-6 border border-border">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-foreground">Perbandingan Marketplace</h3>
            ...
            <MarketplaceChart data={marketplaceChartData} />
          </div>

          {/* Transactions List */}
          <div className="mt-6 bg-card rounded-xl p-4 lg:p-6 border border-border">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-4">
              <h3 className="font-semibold text-foreground">Daftar Transaksi Marketplace</h3>
